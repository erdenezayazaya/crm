...
public class ClientData {
	...
	public double getOpporAmount() {
		return OpporAmount;
	}
	public void setOpporAmount(double opporAmount) {
		OpporAmount = opporAmount;
	}
	public int getOpporProbability() {
		return OpporProbability;
	}
	...
	public String getOpporDescription() {
		return OpporDescription;
	}
	public void setOpporDescription(String opporDescription) {
		OpporDescription = opporDescription;
	}
